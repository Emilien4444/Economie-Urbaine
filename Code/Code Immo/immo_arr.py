...
geo = r"C:\Users\ewena\Documents\Ecole\Economie\macro\projet\ARRONDISSEMENT_MUNICIPAL.shp" 
...
df_f = geo_df.merge(df_pi, left_on="INSEE_ARM", right_on="codgeo")
...
com_map = df_f.plot(column="pxm2_median_all", ax=ax, legend=True, legend_kwds={'label': "prix median par m2 à Lyon", 'orientation':"horizontal"}, linewidth=1, alpha=0.9, edgecolor="black", cmap=cmap, vmin=vmin, vmax=vmax)


plt.title("carte des prix médians de la moyenne entre prix par m2 pour appartement et maisons par arrondissements de Lyon.")
plt.show()
